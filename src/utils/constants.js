export {
  ...
  editProfileButton, addPlaceButton, editFormElement, addFormElement,
  editAvatarFormElement, avatarContainer, avatarImage};
...
const editAvatarFormElement = document.querySelector('#popup-change-avatar .popup__container');
